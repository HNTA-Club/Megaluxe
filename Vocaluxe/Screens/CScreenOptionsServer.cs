...
namespace Vocaluxe.Screens
{
    public class CScreenOptionsServer : CMenu
    {
        ...
        public override void LoadTheme(string xmlPath)
        {
            ...
            if (_SelectSlides.ContainsKey(_SelectSlideServerActive))
            {
                _SelectSlides[_SelectSlideServerActive].SetValues<EOffOn>((int)CConfig.Config.Server.ServerActive);
            }

            if (_SelectSlides.ContainsKey(_SelectSlideServerEncryption))
            {
        ...
        public override bool HandleInput(SKeyEvent keyEvent)
        {
            ...
            switch (keyEvent.Key)
            {
                ...
                case Keys.Enter:
                    ...
                    else if (_Buttons.ContainsKey(_ButtonServer) && _Buttons[_ButtonServer].Selected)
                    {
