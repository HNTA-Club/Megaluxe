    ...
    public partial class CSong
    {
        ...
        private class CSongLoader
        {
            ...
            public bool InitPaths(string filePath)
            {
                ...
                foreach (var folder in CBase.Config.GetSongFolders().Where(folder => _Song.Folder.StartsWith(folder)))
                {
                    ...
                    else
                    {
                        ...
                        var pos = _Song.FolderName.IndexOf("\\", StringComparison.Ordinal);
                        if (pos >= 0)
                        {
            ...
            public bool ReadNotes(bool forceReload = false)
            {
                ...
                if (changesMade.IsModified)
                {
                    ...
                    {
                        var name = Path.GetFileNameWithoutExtension(_Song.FileName);
